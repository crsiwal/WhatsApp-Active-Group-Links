...
/* * ***********************************************************************
 *  File: Password.php
 *  Path: application/libraries/Password.php
 ...
 *  -----------         ----------              ----------------
 *  Rahul Siwal         29/07/2019              Created
 *
 *
 */
if (!class_exists('Password')) {
    ...
    class Password {
        ...
        private function passwordHash($iteration_count_log2, $portable_hashes) {
        ...
        private function crypt_private($password, $setting) {
            $output = (substr($setting, 0, 2) === '*0') ? '*0' : '*1';
